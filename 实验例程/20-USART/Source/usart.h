...
*函数声明
**********************************************************************************************/
extern void usart_init(unsigned int bound);                     //usart1初始化
extern void clean_usart(void);                                  //清除串口缓冲区
extern void usart_send(unsigned char *s,unsigned char len);  //串口1发送数据
#endif
